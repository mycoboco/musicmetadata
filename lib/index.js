...
var headerTypes = [
  ...
  {
    buf: new Uint8Array([0x49, 0x44, 0x33]), // ID3
    tag: require('./id3v2')
  },
  {
    buf: new Uint8Array([0x66, 0x74, 0x79, 0x70, 0x4d, 0x34, 0x41]), // ftypM4A
    tag: require('./id4'),
    offset: 4
  },
  {
    buf: new Uint8Array([0x66, 0x74, 0x79, 0x70, 0x6d, 0x70, 0x34, 0x32]), // ftypmp42
    tag: require('./id4'),
    offset: 4
  },
  {
    buf: new Uint8Array([0x4f, 0x67, 0x67, 0x53]), // OggS
    tag: require('./ogg')
  },
  {
    buf: new Uint8Array([0x66, 0x4c, 0x61, 0x43]), // fLaC
    tag: require('./flac')
  },
  {
    buf: new Uint8Array([0x4d, 0x41, 0x43]), // MAC
