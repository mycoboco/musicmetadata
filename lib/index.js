...
module.exports = function (stream, opts, callback, fileSizeCallback) {
  console.log(opts, callback, fileSizeCallback)
  if (typeof opts === 'function') {
    var tmp = callback
    callback = opts
    fileSizeCallback = tmp
    opts = {}
  }
  ...
  istream.once('data', function (result) {
    ...
    }, done, fileSizeCallback, fileSizeCallback)
